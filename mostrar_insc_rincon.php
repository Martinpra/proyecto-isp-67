...
{
window.location =
"mostrar_insc_rincon.php?search_text="+document.form1.search_text.value+"&starting="+page;
}
</script>
<?php
//qry a modificar segun tabla que queremos consultar
$qry = "SELECT * FROM insc_rincon";
...
$result = $obj->result;
?>
<form name="form1" action="mostrar_insc_rincon.php" method="POST">

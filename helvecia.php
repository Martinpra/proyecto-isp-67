...
<?php
   ...
   <section id="inicio">
     ...
     <h5>Ingrese su Nombre: <input type="text" name="nombre" placeholder="Nombre" required maxlength="30"></h5>
      <h5>Ingrese Apellido: <input type="text" name="direccion" placeholder="Direccion" required maxlength="30"></h5>
    ...
    ?>
     <?php
      ...
      <h3>Su numero de registro es <?php $datos_db=mysqli_connect("localhost","w220226_yapeyu", "MartinchO33", "w220226_isp67") or die ("no se puede conectar con la base");
